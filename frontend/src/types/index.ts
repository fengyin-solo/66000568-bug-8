...
export interface CircuitBreaker { taskId: string; failureCount: number; state: string; cooldownUntil: number; touched?: boolean }
export interface ExecutionInfo { workflow: DAGWorkflow | null; logs: ExecutionLog[]; circuitBreakers: CircuitBreaker[]; completed: boolean; serverTime?: number; receivedAt?: number }
